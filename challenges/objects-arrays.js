...
*/
const animalNames = []; 
const bothNames = zooAnimals.forEach( (animal) => { animalNames.push(`${animal.animal_name} ${animal.scientific_name}`);});
...
*/
const populationTotal = zooAnimals.reduce((totalPop, animal)=> totalPop += animal.population);
